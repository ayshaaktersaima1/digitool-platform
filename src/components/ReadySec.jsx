...
const ReadySec = () => {
    return (
        <div className='py-20 md:py-40 bg-linear-65 from-[#4f39f6] to-[#9514fa] px-2 md:px-[10%] text-white flex flex-col justify-center items-center text-center '>
            <h1 className='pb-4 text-[40px] font-extrabold'>Ready to Transform Your Workflow?</h1>
            <p className='pb-10'>Join thousands of professionals who are already using Digitools to work smarter.Start your free trial today.</p>
