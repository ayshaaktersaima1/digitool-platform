    ...
    return (
        <div className='mx-2 md:mx-[10%]'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-32 items-stretch'>
                ...
                {/* 2nd card */}
                <div className='flex flex-col h-full text-left border border-[#f2f2f2] rounded-2xl bg-[#f9fafcFF] p-6'>
                    <h1 className='text-color text-2xl font-bold pb-2'>Pro</h1>
                    <p className='text-sec pb-6'>Best for professionals</p>
                    <h2 className='text-sec text-xl pb-6'><span className='text-color text-[40px] font-bold'>$29</span>/month</h2>
                    <div className='space-y-2 pb-6'>
                        <div className='flex items-center gap-2'>
                            <Check className='text-[#30b868]' />
                            <p className='text-sec font-medium'>Access to all premium tools</p>
                        </div>
                        <div className='flex items-center gap-2'>
                            <Check className='text-[#30b868]' />
                            <p className='text-sec font-medium'>Unlimited templates</p>
                        </div>
                        <div className='flex items-center gap-2'>
                            <Check className='text-[#30b868]' />
                            <p className='text-sec font-medium'>Priority support</p>
                        </div>
                        <div className='flex items-center gap-2'>
                            <Check className='text-[#30b868]' />
                            <p className='text-sec font-medium'>Unlimited projects</p>
                        </div>
                        <div className='flex items-center gap-2'>
                            <Check className='text-[#30b868]' />
                            <p className='text-sec font-medium'>Cloud sync</p>
                        </div>
                        <div className='flex items-center gap-2'>
                            <Check className='text-[#30b868]' />
                            <p className='text-sec font-medium'>Advanced analytics</p>
                        </div>
                    </div>
                    <button className='btn btn-block bg-linear-65 from-[#4f39f6] to-[#9514fa] text-white font-bold rounded-3xl mt-auto'>Get Started Free</button>
                </div>
