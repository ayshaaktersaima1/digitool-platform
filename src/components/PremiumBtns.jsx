...
const PremiumBtns = ({ fetchData, setNavCount }) => {
    ...
    return (
        <div className='mt-8 lg:mt-30 space-y-4 mx-2 md:mx-[10%]  flex flex-col items-center mb-11'>
            <h1 className='text-color font-extrabold text-3xl md:text-5xl text-center'>Premium Digital Tools</h1>
            <p className='text-sec font-normal text-base w-auto lg:w-136 text-center'>Choose from our curated collection of premium digital products designed to boost your productivity and creativity.</p>
